...
SELECT countries.ISO_Code, aux_mortality_rate_1to4.country_name, aux_mortality_rate_1to4.country_code,
		aux_mortality_rate_1to4.year, aux_mortality_rate_1to4.mortality_rate_1to4
