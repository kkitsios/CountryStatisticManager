...
SELECT countries.ISO_Code, aux_crude_birth_rate.country_name, aux_crude_birth_rate.country_code,
		aux_crude_birth_rate.year, aux_crude_birth_rate.crude_birth_rate
