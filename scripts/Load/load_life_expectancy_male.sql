...
SELECT countries.ISO_Code, aux_life_expectancy_male.country_name, aux_life_expectancy_male.country_code,
		aux_life_expectancy_male.year, aux_life_expectancy_male.life_expectancy_male
