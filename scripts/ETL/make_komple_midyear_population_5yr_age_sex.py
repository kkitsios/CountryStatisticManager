import parser
import csv
dataset = "../../InternationalDatasetsSmall/midyear_population_5yr_age_sex.csv"
out_dir = "./outputs/internationalDataset/"
prefix = "5yr_age_"
dataset_hashmap = parser.load_csv(dataset)
fixed_columns = ["country_code", "country_name", "year","total_flag","starting_age","age_group_indicator","ending_age"]
